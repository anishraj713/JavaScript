...
switch (language) {
  ...
  case "spanish":
    ...
    break;
  case "english":
    console.log("3rd MOST number of native speakers!");
    break;
  case "hindi":
    console.log("4th MOST number of native speakers!");
    break;
  case "arabic":
    console.log("5th MOST number of native speakers!");
    break;
  default:
...
// TODO: LECTURE: The Conditional (Ternary) Operator
/*
